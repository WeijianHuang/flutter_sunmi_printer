...
public class FlutterSunmiPrinterPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    private String SET_UNDER_LINE = "setUnderLine";
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        if (call.method.equals(RESET)) {
            ...
            result.success(null);
        } else if (call.method.equals(SET_UNDER_LINE)) {
            flutterSunmiPrinterModule.setUnderLine();
            result.success(null);
            ...
            flutterSunmiPrinterModule.printBarCode(getText(call),getSymbology(call));
            result.success(null);
    ...
    private Integer getSymbology(MethodCall call) {
        Integer symbology = call.argument("symbology");
        if (symbology == null || symbology < 0) {
            return 7;
        }
        return symbology;
    }
